          ...
          <tbody>
            <tr  className="hover:bg-gray-50">
               ...
               <tr  className="hover:bg-gray-50">
                ...
                <td className="border border-gray-300 px-3 py-1">12.0.0</td>
              </tr> <tr  className="hover:bg-gray-50">
                <td className="border border-gray-300 px-3 py-1">Product ID</td>
                <td className="border border-gray-300 px-3 py-1">45834</td>
              </tr> <tr  className="hover:bg-gray-50">
                ...
                <td className="border border-gray-300 px-3 py-1">DK Studio Host</td>
              </tr> <tr  className="hover:bg-gray-50">
                <td className="border border-gray-300 px-3 py-1">Site Version</td>
                <td className="border border-gray-300 px-3 py-1">12</td>
           </tr>
          </tbody>
        </table>
      </div>
...
const AppRouter = () => {
  ...
  const isAuthPage = ['/login', '/registration', '/propicasso/login','/message'].includes(location.pathname);
